module app.misInversiones {
    ...
    class MisInversionesNacionalesCtrl implements IMisInversionesNacionalesViewModel {
        ...
        static $inject = ['constantService', 'dataService','$localForage', 'authService', 'extrasService', '$scope'];
        ...
        getBalance(input: app.domain.IBalanceInput): void {
            ...
            this.$localForage.getItem('accessToken')
                .then((responseToken) => {
                    this.dataService.postWebService(this.constantService.apiBalanceURI + 'getSingle', input, responseToken)
        ...
        getCartola(input: app.domain.ICartolaInput): void {
            ...
            this.$localForage.getItem('accessToken')
                .then((responseToken) => {
                    this.dataService.postWebService(this.constantService.apiCartolaURI + 'getSingle', input, responseToken)
        ...
        getConceptosTitulo(titulo: app.domain.ICartolaTitulo, loadingIndex: number): void {
            if (!titulo.DatosCargados) {
                ...
                this.$localForage.getItem('accessToken')
                    .then((responseToken) => {
                        this.dataService.postWebService(this.constantService.apiCartolaURI + 'getConceptosTitulo', input, responseToken)
